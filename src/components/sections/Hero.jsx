        ...
        <div className="self-center w-full">
          <div className="w-full text-zinc-900 dark:text-zinc-100 px-4 sm:px-6 flex flex-col md:grid md:grid-cols-3 items-center gap-10">
            ...
            <div className="md:col-span-2 order-2 md:order-1 text-center md:text-left">
              <div>
                <h1 className="font-black mt-3 text-3xl md:text-5xl max-w-full">
                  {user_info.main.name}
                </h1>
                <h2 className="md:text-lg text-md">{user_info.main.role}</h2>
                <p className="mt-4 sm:mt-6 dark:text-zinc-300 text-base font-light leading-7">
                  {user_info.main.description}
                </p>
              </div>

              <div className="flex flex-wrap justify-center md:justify-start md:gap-16 gap-3 mt-6">
                <a
                  href="#projects"
                  className=" hover:text-red-800 dark:hover:text-red-500 transition-all duration-300 flex gap-2 hover:gap-3 items-center"
                >
