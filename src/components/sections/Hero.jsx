...
// Use public assets via getAssetPath — do not import from /public directly
const heroPhoto = getAssetPath("photo.jpg");
...
function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative scroll-mt-16 min-h-screen flex items-center py-20 px-4 sm:px-6 lg:px-8 xl:px-16 2xl:px-24"
    >
      {/* Background gradient */}
